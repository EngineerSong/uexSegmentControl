...
//    NSArray *otherValues = [[NSArray alloc] initWithContentsOfFile:plistPath2];
    ...
    for (int i =0; i <num; i++) {
        ...
        view.frame = CGRectMake(10+(10+view_width)*(i%4), 20+45*(i/4), view_width, 30);
    ...
    for (int i=0; i<num2; i++) {
        BYSelectionView *view = [[BYSelectionView alloc] initWithFrame:CGRectMake(10+(10+view_width)*(i%4),CGRectGetMaxY(bg_view.frame)+20+45*(i/4), view_width, 30)];
